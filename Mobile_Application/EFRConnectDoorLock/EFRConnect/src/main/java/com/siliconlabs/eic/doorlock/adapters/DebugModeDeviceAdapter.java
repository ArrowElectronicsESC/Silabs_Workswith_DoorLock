...
import com.siliconlabs.eic.doorlock.beaconutils.altbeacon.AltBeacon;
...
import com.siliconlabs.eic.doorlock.views.ServiceItemContainerRe;
...
import static com.siliconlabs.eic.doorlock.bluetoothdatamodel.parsing.ScanRecordParser.SPLIT;
...
public class DebugModeDeviceAdapter extends ScannedDevicesAdapter<BluetoothDeviceInfo> {
    ...
    private static final String TAG = DebugModeDeviceAdapter.class.getSimpleName();
    ...
    public static class ViewHolder extends DeviceInfoViewHolder<BluetoothDeviceInfo> implements View.OnClickListener {
        ...
        private void gotoDeviceProperty() {
            debugModeCallback.gotoDeviceProperty(device);
        }
        ...
        public void addAdvertsToContainer(AdvertismentData advertismentData) {
            Log.e(TAG, "Advertise details in Container: " + Arrays.asList(advertismentData.getRows()));
            advertisementContainer.removeAllViews();

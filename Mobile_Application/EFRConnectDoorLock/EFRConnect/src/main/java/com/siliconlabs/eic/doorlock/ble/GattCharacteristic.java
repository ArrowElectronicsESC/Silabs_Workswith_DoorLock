...
import com.siliconlabs.eic.doorlock.ble.values.ByteArrayValue;
import com.siliconlabs.eic.doorlock.ble.values.TemperatureValue;
import com.siliconlabs.eic.doorlock.ble.values.ValueFactory;
...
public enum GattCharacteristic {
    ...
    DockStatus(0xb77acfa5, "com.sensedriver.characteristic.hud.dock_status", BluetoothGattCharacteristic.FORMAT_UINT16),
    ...
    door_lock_state("d42ce43d-65f7-47e7-a32a-97e4cf70e35b", "custom.type", BluetoothGattCharacteristic.FORMAT_UINT8),
    door_lock_req("2af72429-66a3-4619-9dd8-75cc7e0b6098", "custom.type", BluetoothGattCharacteristic.FORMAT_UINT8);
    ...
    GattCharacteristic(String uuid, String type, ValueFactory format) {
        this.number = UuidUtils.parseIntFromUuidStart(uuid);
        this.type = type;
        this.format = -1;
        this.valueFactory = format;
        this.uuid = UUID.fromString(uuid);

...
class BluetoothLEGatt {
    ...
    BluetoothLEGatt(final Context context, BluetoothDevice pDevice) {
        ...
        gattCallback = new BluetoothGattCallback() {
            ...
            public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
                if (status == BluetoothGatt.GATT_SUCCESS) {
                    //Log.d("onCharacteristicWrite","Char " + getCharacteristicsValue(characteristic) + " -> " + getCharacteristicName(characteristic.getUuid()));
                    Timber.d("Char " + getCharacteristicsValue(characteristic) + " -> " + getCharacteristicName(characteristic.getUuid()));
                } else {
                    //Log.e("onCharacteristicWrite","onCharacteristicWrite received: " + status);
    ...
    private boolean discoverServices() {
        ...
        synchronized (this) {
            ...
            //hasServicesCached = !gatt.getServices().isEmpty(); //TODO Uncomment - Trying to alwayes discover services

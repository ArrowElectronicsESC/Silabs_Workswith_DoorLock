...
import com.siliconlabs.eic.doorlock.activity.BaseActivity;
import com.siliconlabs.eic.doorlock.adapters.DeviceInfoViewHolder;
import com.siliconlabs.eic.doorlock.adapters.ScannedDevicesAdapter;
...
public class SelectDeviceDialog extends DialogFragment implements Discovery.BluetoothDiscoveryHost {
    ...
    private void startDiscovery(Discovery discovery, boolean clearCachedDiscoveries) {
        ...
        //TODO
        discovery.addFilter(GattService.DOOR_LOCK);
    ...
    private Intent getIntent(BlueToothService.GattConnectType connectType, FragmentActivity activity) {
        if (connectType == BlueToothService.GattConnectType.DOOR_LOCK) {
            return (new Intent(activity, DoorLockActivity.class));
        }
        return null;
    }
